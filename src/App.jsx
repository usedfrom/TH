...
// Стили для PDF (табличный вид, как в Excel)
...
const generateExcel = (formData) => {
  // Создаём новый workbook
  const wb = XLSX.utils.book_new();
  
  // Данные для листа (имитируем структуру вашего Excel)
  const wsData = [
    // Заголовки (row1-row3)
    ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'Приложение № 4'],
    ...
    // Номер и дата
    ['Дата', '', '', '', formData.date ? new Date(formData.date).toLocaleDateString('ru-RU') : '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'Дата', '', '', '', formData.date ? new Date(formData.date).toLocaleDateString('ru-RU') : '', '', '', '', '№', '', '', '', formData.number || ''],
    ['Экземпляр №', '', '', '', formData.copyNumber || ''],
    // Секция 1
    ...
    ['3. Груз'],
    [formData.cargoName || '-'],
    ['(отгрузочное наименование груза (для опасных грузов - в соответствии с ДОПОГ), его состояние и другая необходимая информация о грузе)', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', formData.packages || '-', '', '', '', formData.packaging || '-'],
    ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '(количество грузовых мест, маркировка, вид тары и способ упаковки)'],
    ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', formData.grossWeight || '-', '', '', '', formData.netWeight || '-', '', '', '', formData.dimensions || '-', '', '', '', formData.volume || '-'],
    ...
    [formData.route || '-', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', formData.deliveryTerms || '-'],
    ...
    [formData.vehicleType || '-', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', formData.vehicleReg || '-'],
    ...
    ['8. Прием груза'],
    [formData.loadingEntity || formData.shipperDetails || '-'],
    ['(реквизиты лица, осуществляющего погрузку груза в транспортное средство)'],
    [formData.loadingAddress || '-'],
    ['(адрес места погрузки)'],
    ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', formData.loadingTime || '-'],
    ['"____" ____________ 2025 г.    ______ч:______мин.'],
    ['"____" ____________ 2025 г.    ______ч:______мин.'],
    ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', formData.loadingSignature || '-'],
    ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', formData.driverDetails || '-'],
    ['9. Переадресовка (при наличии)'],
    [formData.redirection || '-'],
    ['10. Выдача груза'],
    [formData.unloadingAddress || '-'],
    ['(адрес места выгрузки)'],
    ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', formData.unloadingTime || '-'],
    ['"____" ____________ 2025 г.    ______ч:______мин.'],
    ['"____" ____________ 2025 г.    ______ч:______мин.'],
    ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', formData.unloadingSignature || '-'],
    ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', formData.driverDetails || '-'],
    ...
    [formData.cost || '-'],
    ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', formData.carrierSignDate ? new Date(formData.carrierSignDate).toLocaleDateString('ru-RU') : '-'],
    ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', formData.shipperSignDate ? new Date(formData.shipperSignDate).toLocaleDateString('ru-RU') : '-'],
  ];
  ...
  ws['!cols'] = Array(82).fill({ wch: 10 });

  // Добавляем лист в workbook
  XLSX.utils.book_append_sheet(wb, ws, 'ТН');

  // Генерируем и скачиваем файл
  XLSX.writeFile(wb, `nakladnaya_${formData.number || 'export'}.xlsx`);
};
...
function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <p>Заполните поля ниже. Нажмите "Скачать PDF" или "Скачать Excel" для генерации документа.</p>
      ...
      <div style={{ marginTop: '20px', display: 'flex', gap: '10px' }}>
        ...
        <button onClick={() => generateExcel(formData)}>Скачать Excel</button>
      </div>
